...
<jsp:useBean id = "userBean" class= "employees.Employee" scope="request"> </jsp:useBean>
<body>
<div> 
...
<% } else if(designation.equals("2")) { %> <jsp:include page="traineeHeading.jsp">
	<jsp:param value="<%=userBean.getfName() %>" name="name"/></jsp:include>
<% }
